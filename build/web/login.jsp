    ...
    <body>
        <div class="card-container">
            <div class="card">
                ...
                <button type="button" onclick="window.location.href='index.jsp'" style="width: 100%; background-color: #007BFF; color: white; padding: 10px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;">
    regresar al inicio
</button>
